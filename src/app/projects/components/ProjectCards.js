...
import CardContainerAOS from "@/app/commons/components/elements/CardContainerAOS";
...
export default function ProjectsCards({ is_featured, slug , image , title ,description, tech_stack ,Index}) {
            ...
            <div className="rounded-xl transition-all duration-300 shadow-sm lg:hover:shadow-md relative border dark:bg-neutral-800 border-neutral-200 dark:border-neutral-800 lg:hover:scale-[102%] h-full cursor-pointer group">
              ...
              <div className="flex flex-col">
                ...
                <div className="px-5 py-6 space-y-3 ">
                  <h1 className="text-xl group-hover:text-teal-500">
                    {title}
                  </h1>
